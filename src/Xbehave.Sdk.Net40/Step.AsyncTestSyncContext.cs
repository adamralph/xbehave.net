// <copyright file="Step.AsyncTestSyncContext.cs" company="xBehave.net contributors">
...
namespace Xbehave.Sdk
{
    ...
    /// <summary>
    /// Provides the <see cref="AsyncTestSyncContext"/> implementation as a protected class.
    /// This is done to keep abstract methods protected and to be able to use <see cref="AsyncTestSyncContext"/>
    /// in subclasses.
    /// </summary>
    public abstract partial class Step
    {
        ...
        /// </summary>
        protected class AsyncTestSyncContext : SynchronizationContext, IDisposable
        {

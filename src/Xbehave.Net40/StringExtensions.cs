...
namespace Xbehave
{
    ...
    public static partial class StringExtensions
    {
        ...
        {
            return new GivenDefinition(CurrentThread.Scenario.AddStep(new Step(message, DisposableFunctionFactory.Create(arrange))));
        }
        ...
        {
            return new GivenDefinition(CurrentThread.Scenario.AddStep(new Step(message, arrange)));
        }
        ...
        {
            return new GivenDefinition(CurrentThread.Scenario.AddStep(new Step(message, DisposableFunctionFactory.Create(arrange, dispose))));
        }
        ...
        {
            return new WhenDefinition(CurrentThread.Scenario.AddStep(new Step(message, DisposableFunctionFactory.Create(act))));
        }
        ...
        {
            return new ThenDefinition(CurrentThread.Scenario.AddStep(new Step(message, DisposableFunctionFactory.Create(assert), true)));
        }
        ...
        {
            return new ThenDefinition(CurrentThread.Scenario.AddStep(new Step(message, DisposableFunctionFactory.Create(assert))));
        }
        ...
        {
            return new ThenDefinition(CurrentThread.Scenario.AddStep(new Step(message, DisposableFunctionFactory.Create(assert), "Skipped for an unknown reason.")));
        }
    }
}

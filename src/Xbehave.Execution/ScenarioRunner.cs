// https://github.com/xunit/xunit/blob/2.4.1/src/xunit.execution/Sdk/Frameworks/Runners/XunitTestRunner.cs
using System;
...
namespace Xbehave.Execution
{
    ...
    /// </summary>
    public class ScenarioRunner : ScenarioRunnerBase<IXunitTestCase>
    {
        ...
        public ScenarioRunner(IScenario test,
        ...
        /// <inheritdoc/>
        protected override async Task<Tuple<RunSummary, string>> InvokeTestAsync(ExceptionAggregator aggregator)
        {
        ...
        protected virtual Task<RunSummary> InvokeTestMethodAsync(ExceptionAggregator aggregator)
            => new ScenarioInvoker(Test, MessageBus, TestClass, ConstructorArguments, TestMethod, TestMethodArguments, BeforeAfterAttributes, aggregator, CancellationTokenSource).RunAsync();
    }
}

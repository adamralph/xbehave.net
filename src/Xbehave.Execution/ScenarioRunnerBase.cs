// https://github.com/xunit/xunit/blob/2.4.1/src/xunit.execution/Sdk/Frameworks/Runners/TestRunner.cs
using System;
...
namespace Xbehave.Execution
{
    ...
    public abstract class ScenarioRunnerBase<TTestCase>
        where TTestCase : ITestCase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScenarioRunnerBase{TTestCase}"/> class.
        /// </summary>
        ...
        protected ScenarioRunnerBase(IScenario test,
        ...
        {
            GuardEx.ArgumentNotNull("test", test);
            GuardEx.ArgumentValid("test", "test.TestCase must implement " + typeof(TTestCase).FullName, test.TestCase is TTestCase);
        ...
        /// </summary>
        protected IScenario Test { get; set; }
        ...
        public async Task<RunSummary> RunAsync()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    TestResultMessage testResult = null;
                    ...
                    if (!CancellationTokenSource.IsCancellationRequested)
                        if (testResult != null && !MessageBus.QueueMessage(testResult))
                            CancellationTokenSource.Cancel();
                }
        ...
        protected abstract Task<Tuple<RunSummary, string>> InvokeTestAsync(ExceptionAggregator aggregator);
    }
}

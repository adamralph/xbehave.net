// UPSTREAM: https://raw.githubusercontent.com/xunit/xunit/2.4.1/src/xunit.execution/Sdk/Frameworks/TheoryDiscoverer.cs
using System;
...
#pragma warning restore CS0618
        ...
        public virtual IEnumerable<IXunitTestCase> Discover(ITestFrameworkDiscoveryOptions discoveryOptions, ITestMethod testMethod, IAttributeInfo theoryAttribute)
        {
            ...
            if (discoveryOptions.PreEnumerateTheoriesOrDefault())
            {
                try
                {
                    ...
                    if (results.Count == 0)
                        results.Add(CreateTestCaseForNoData(discoveryOptions, testMethod));
        ...
        protected virtual IXunitTestCase CreateTestCaseForNoData(ITestFrameworkDiscoveryOptions discoveryOptions, ITestMethod testMethod) =>

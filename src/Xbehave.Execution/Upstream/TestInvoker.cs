// UPSTREAM: https://raw.githubusercontent.com/xunit/xunit/2.4.1/src/xunit.execution/Sdk/Frameworks/Runners/TestInvoker.cs
using System;
using System.Linq;
...
namespace Xunit.Sdk
{
        ...
        where TTestCase : ITestCase
    {
                    ...
                    try
                    {
                        ...
                        if (!CancellationTokenSource.IsCancellationRequested)
                        {
                            ...
                            if (!CancellationTokenSource.IsCancellationRequested && !Aggregator.HasExceptions)
                                runSummary.Aggregate(await InvokeTestMethodAsync(testClassInstance));
        ...
        protected virtual async Task<RunSummary> InvokeTestMethodAsync(object testClassInstance)
        {

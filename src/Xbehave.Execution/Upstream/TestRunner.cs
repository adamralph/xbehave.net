// UPSTREAM: https://raw.githubusercontent.com/xunit/xunit/2.4.1/src/xunit.execution/Sdk/Frameworks/Runners/TestRunner.cs
using System;
        ...
        public async Task<RunSummary> RunAsync()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (exception == null && runSummary.Total == 0)
                    ...
                    if (!CancellationTokenSource.IsCancellationRequested && testResult != null)
